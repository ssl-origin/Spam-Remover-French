...
<li>Ensuite, réactivez le forum et vérifiez qu‘il fonctionne correctement et que le spam a été supprimé.</li>
	...
	'ACP_SPAMREMOVER_SPAM_REMOVED'				=> 'Le spam a été supprimé. Un total de %u messages, %u sujets, %u utilisateurs et %u messages privés ont été supprimés. Les messages supplémentaires sont supprimés lorsque le premier message d‘un sujet est marqué comme spam, mais ne sont pas inclus dans ce total.',
	'ACP_SPAMREMOVER_SPAM_REMOVED_PROGRESS'		=> 'Le spam est supprimé. Un total de %u messages, %u sujets, %u utilisateurs et %u messages privés ont été supprimés jusqu‘à présent. Vous avez %s%% terminé.',
	...
	'ACP_SPAMREMOVER_TEST_MODE_ERROR'			=> 'Le mode test étant activé, aucune action n‘a été entreprise.',
